...
import { MessagingDropdownVComponent } from './messaging-dropdown-v.component';

describe('MessagingDropdownVComponent', () => {
  let component: MessagingDropdownVComponent;
  ...
  beforeEach(async(() => {
   TestBed.configureTestingModule({
     ...
     declarations: [MessagingDropdownVComponent],
   }).compileComponents()
 
   let fixture = TestBed.createComponent(MessagingDropdownVComponent);
     fixture = TestBed.createComponent(MessagingDropdownVComponent);
      component = fixture.componentInstance; 
     component.ngOnInit();
   
 }))
  it('should create the app', async(() => {
    const fixture = TestBed.createComponent(MessagingDropdownVComponent);
  ...
  it('should render title as Message Transformers ', async(() => {
   ...
   expect(el.textContent).toContain('Message Validators');
 }));
