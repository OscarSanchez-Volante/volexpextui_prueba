...
data:string;
 ...
 status:string;
  Title=[{
    "name":"Associate"
  },{"name":"Account Analyst"},{"name":"Branch Manager"},{"name":"Business Analyst"},{"name":"Director"},{"name":"Developer"},{"name":"Finance Director"},{
    "name":"Internal Auditor"
  },{"name":"Managing Director"},{"name":"Regional Director"},{"name":"Senior Analyst"},{"name":" Technical Architect "},{"name":"Vice President"},{"name":"Other"}]
